...
public actor LLama {
    ...
    public init(modelPath: String) throws {
        ...
        guard let context = llama_new_context_with_model(model, ctxParams) else {
            ...
            llama_backend_free()
            throw InitializationError(message: "Failed to initialize context", code: .failedToInitializeContext)
        }
    ...
    private func tokenize(text: String, add_bos: Bool) -> [llama_token] {
        ...
        let tokenCount = llama_tokenize(model, text, Int32(utf8Data.count), tokens, Int32(nTokens), add_bos, false)
